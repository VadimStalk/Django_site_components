...
#                                             'required':'Без заголовка никак',}) # через widget меняем стиль отображения в поле ввода. Собственный валидатор, обработчик ошибок
...
class AddPostForm(forms.ModelFormForm):
